  ...
  <div class="content">
    ...
    <div id="box">
      ...
      <div class="box-panel">
        <table width=100%;>
        <tr>
        <td style="width:65%; padding-top:15px;"><a href="inputuser.php">
            <button class="btn"><i class="fa fa-plus" style="font-size:16px">
            <span style="padding-left: 5px"> Pengguna</span></i></button></a></span>
        </td>
        <td>
            <form method="post" action="lihatuser.php">
            <?php
            $cari = $_POST['cariuser'];
            ...
            {
              echo'
                <a href="lihatuser.php" style="font-size:12px;">Reset Pencarian</>
                <input type="text" name="cariuser" placeholder="Cari Pengguna" value='.$cari.'>';
            }else{
              echo'<input type="text" name="cariuser" placeholder="Cari Pengguna">';
            }
            ?>
