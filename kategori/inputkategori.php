...
<body>
  ...
  <div class="content">
    <i class="fa fa-plus-square" style="font-size: 28px; padding-top: 25px"><span style="padding-left: 15px">Form Input Kategori</i>

  <div id="container">
      <div id="box">
        <div class="box-top"><i>Menambahkan Data Kategori</i></div>
        <div class="box-panel">
					<form method="POST" action="proses.php">
					<table class="table">
						<tr>
							<td style="text-align: right">ID Kategori</td>
							<td><input type="text" name="idkategori"></td>
						</tr>
						<tr>
							<td style="text-align: right">Nama Kategori</td>
						...
						<tr><td></td></tr><tr><td></td></tr>
							...
							<td>
								<button type="submit" class="btn" name="simpan">
									...
									<span style="padding-left: 20px"><a href="../kategori/lihatkategori.php" class="btn-default">
										<i class="fa fa-backward" style="font-size:15px">
