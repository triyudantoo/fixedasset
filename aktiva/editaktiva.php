...
<body>
  ...
  <div class="sidebar">
    ...
    <ul id="nav">
      ...
      <li><a href="../kategori/inputkategori.php"><i class="fa fa-flag" style="font-size:18px"><span style="padding-left: 15px">Kategori</span></i></a></li>
      <li><a href="../aktiva/inputaktiva.php"><i class="fa fa-briefcase" style="font-size:18px"><span style="padding-left: 15px">Aktiva Tetap</span></i></a></li>
      <li><a href="../penyusutan/inputpenyusutan.php"><i class="fa fa-calculator" style="font-size:18px"><span style="padding-left: 15px">Penyusutan</span></i></a></li>
      <li><a href="../user/inputuser.php"><i class="fa fa-user" style="font-size:18px"><span style="padding-left: 20px">Pengguna</span></i></a></li>
      <li><a href="../logout.php"><i class="fa fa-sign-out" style="font-size:18px"><span style="padding-left: 15px">Keluar</i></a></li>
    </ul>
  </div>

  <div class="content">
    <i class="fa fa-edit" style="font-size: 28px; margin-top: 25px"><span style="padding-left: 15px">Form Edit Aktiva</i>
    ...
    <?php
      $id = $_GET['kdaktiva'];
    	...
    	$db = new database();
    	$kon = $db->connect();
      $query = $kon->query("SELECT * FROM aktiva where kdaktiva='$id'");
      while ($row = $query->fetch_array())
      {
        $kdaktiva   = $row['kdaktiva'];
        $namaaktiva = $row['namaaktiva'];
        $thn_beli   = $row['thn_beli'];
    ...
    ?>
      ...
      <div id="box">
        <div class="box-top"><i>Mengubah Data Aktiva</i></div>
        <div class="box-panel">
					<form method="POST" action="proses.php">
					<table class="table">
						<tr>
							<td style="text-align: right">Kode Aktiva</td>
							<td><input type="text" name="kdaktiva" readonly value="<?=$kdaktiva;?>"></td>
						</tr>
						<tr>
							<td style="text-align: right">Nama Aktiva</td>
              <td><input type="text" name="namaaktiva" value="<?=$namaaktiva;?>"></td>
						</tr>
            <tr>
							<td style="text-align: right">Tahun Perolehan</td>
              <td>
                <select class="form-control" name="thn_beli" placeholder="Pilih Tahun" required>
                  <option value="<?php echo $thn_beli; ?>"><?php echo $thn_beli; ?></option>
                  <option value=""></option>
            ...
            <tr>
              ...
              <td>
                <select class="form-control" name="idkategori" required>
                  <option value="<?php echo $idkategori; ?>"><?php echo $idkategori; ?></option>
                  <option value=""></option>
                  <?php
                    require_once "../lib/database.php";
                    $db  = new database();
            ...
            <tr>
              ...
              <td><input type="text" name="usia" value="<?=$usia;?>"></td>
						</tr>
            <tr>
