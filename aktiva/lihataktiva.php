...
<body>
  ...
  <div class="content">
      <i class="fa fa-edit" style="font-size: 28px; padding-top: 25px;">
        <span style="padding-left: 15px;">Data Aktiva Tetap</span></i>
    <div id="box">
      <div class="box-top"><i>Menampilkan Aktiva Tetap</i></div>
      <div class="box-panel">
        <table width=100%;>
        <tr>
        <td style="width:65%; padding-top:15px;"><a href="inputaktiva.php">
            <button class="btn"><i class="fa fa-plus" style="font-size:16px">
            <span style="padding-left: 5px"> Aktiva</span></i></button></a></span>
        </td>
        <td>
            <form method="post" action="lihataktiva.php">
            <?php
            $cari = $_POST['cariaktiva'];

            if($_POST['cariaktiva'])
            {
              echo'
                <a href="lihataktiva.php" style="font-size:12px;">Reset Pencarian</>
                <input type="text" name="cariaktiva" placeholder="Cari Aktiva" value='.$cari.'>';
            }else{
              echo'<input type="text" name="cariaktiva" placeholder="Cari Aktiva">';
            }
            ?>
